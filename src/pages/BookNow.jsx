    ...
    >
      ...
      <div className="container">
        ...
        >
          ...
          >
            Complete the form below and our expert team will contact you within
            24 hours
          </p>
        </motion.div>
        ...
        >
              ...
              {status.submitted ? (
                <div style={{ textAlign: "center", padding: "2rem" }}>
                  ...
                  <p style={{ marginBottom: "1.5rem" }}>
                    Thank you for your interest in MT8. Our team will contact
                    you shortly.
                  </p>
                  <button
                    onClick={() =>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-group">
                    ...
                    >
                      {["100", "500", "1000", "5000", "10000", "25000"].map(
                        (amount) => (
                          <button
                            key={amount}
                            type="button"
          ...
          >
            <div className="glass-card" style={{ height: "100%" }}>
              ...
              <div style={{ marginBottom: "2rem" }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: "#94a3b8" }}>
                      Quick and secure account setup with minimum $100 deposit
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: "#94a3b8" }}>
                      Begin your trading journey with expert guidance
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <h4 style={{ marginBottom: "1rem", color: "#00ff88" }}>
                  Why Book With MT8?
                </h4>
                <ul style={{ listStyle: "none", paddingLeft: 0 }}>
                  ...
                  >
                    <span style={{ color: "#00ff88" }}>✓</span> 9 years of
                    proven expertise
                  </li>
                  <li
                    style={{
                  ...
                  >
                    <span style={{ color: "#00ff88" }}>✓</span> 5% maximum daily
                    loss protection
                  </li>
                  <li
                    style={{
                  ...
                  >
                    <span style={{ color: "#00ff88" }}>✓</span> 100% deposit
                    bonus available
                  </li>
                  <li
                    style={{
                  ...
                  >
                    <span style={{ color: "#00ff88" }}>✓</span> 24/7 customer
                    support
                  </li>
                  <li
                    style={{
                  ...
                  >
                    <span style={{ color: "#00ff88" }}>✓</span> Anytime profit
                    withdrawals
                  </li>
                </ul>
              </div>
